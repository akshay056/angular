...
namespace Sonata_eStore.Controllers
{
    public class ProductsController : Controller
    {
        ...
        public async Task<IActionResult> Index(string categoryname = "", int p = 1)
        {
            int pageSize = 3;
            ...
            Category category = await _context.Categories.Where(c => c.Name == categoryname).FirstOrDefaultAsync();
